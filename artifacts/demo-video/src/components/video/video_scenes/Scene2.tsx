      ...
      >
                ...
                >
                  {PRODUCTS.map((p, i) => {
                    ...
                    return (
                      ...
                      >
                        <div className="w-[4cqw] h-[4cqw] rounded-lg overflow-hidden border border-gray-100 flex-shrink-0 flex items-center justify-center bg-gray-50">
                        ...
                        <motion.div
                          className="w-[2cqw] h-[2cqw] rounded-full bg-[#25D366] flex items-center justify-center flex-shrink-0"
                          initial={{ scale: 0 }}
                          animate={filled ? { scale: 1 } : {}}
                          transition={{ type: 'spring', bounce: 0.5 }}
                        >
                          <svg viewBox="0 0 12 10" fill="none" className="w-[1.2cqw]">
        ...
        >
          <div className="h-[12%] bg-[#0D0D0D] flex items-center justify-center flex-shrink-0">
            <span className="text-white text-[1.7cqw] font-black font-display">Mary's Catalog</span>
          </div>
          <div className="h-[10%] flex items-center justify-center flex-shrink-0 border-b border-gray-100">
            <span className="text-[1.8cqw] font-black text-[#0D0D0D] font-display">BILUM BAG</span>
          </div>
