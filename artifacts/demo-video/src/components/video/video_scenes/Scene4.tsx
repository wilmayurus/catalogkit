    ...
    >
      ...
      {portrait ? (
        ...
        <div className="flex-1 min-h-0 overflow-hidden flex flex-col items-center justify-center gap-[1cqh] px-[5cqw] pb-[1cqh]">
          ...
          >
            <div className="relative w-[30cqw] h-[22cqw] bg-white rounded-xl shadow-2xl flex flex-col border border-gray-100">
              <div className="h-[28%] bg-[#ea580c] rounded-t-xl flex items-center justify-center">
                <span className="text-white font-bold text-[3.5cqw]">PDF</span>
              </div>
              <div className="flex-1 grid grid-cols-2 gap-[1cqw] p-[1.5cqw]">
                ...
                <div className="bg-gray-100 rounded-lg flex items-center justify-center">
                  <span className="text-gray-400 text-[1.5cqw]">+more</span>
                </div>
              </div>
              <motion.div
                className="absolute -right-[3cqw] -top-[2cqw] w-[7cqw] h-[7cqw] bg-[#f97316] rounded-full text-white flex items-center justify-center shadow-xl"
                animate={{ y: [0, 8, 0] }}
                transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="w-[3.5cqw] h-[3.5cqw]">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
              </motion.div>
            </div>
            <div className="text-left">
              <h3 className="text-[3.5cqw] font-bold text-[#0D0D0D] font-display">PDF Download</h3>
              <p className="text-[2.5cqw] text-[#f97316] font-medium mt-[0.5cqh]">Print it. Email it.<br/>Share it.</p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ type: 'spring', damping: 20 }}
          >
            <div className="relative w-[38cqw] h-[24cqw] bg-white rounded-2xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden flex-shrink-0">
              <div className="h-[14%] bg-[#0D0D0D] flex items-center justify-center flex-shrink-0">
                <span className="text-white text-[1.6cqw] font-bold tracking-wide">Mary's Catalog</span>
              </div>
              <div className="flex-1 flex items-center justify-center px-[1.5cqw] gap-[1cqh]">
                <div className="text-[1.8cqw] font-bold text-[#0D0D0D]">Thank you!</div>
                <div className="flex gap-[0.8cqw]">
                  {['bilum-bag-clean.png','tropical-fruit-warm.png','product-mask.png'].map((img, i) => (
                    <div key={i} className="w-[5cqw] h-[5cqw] bg-gray-50 rounded-lg border border-gray-100 flex items-center justify-center">
              ...
              <motion.div
                className="mx-[1.5cqw] mb-[1.5cqw] bg-[#25D366] rounded-xl py-[1cqw] flex items-center justify-center gap-[0.8cqw] shadow-lg"
                animate={{ scale: [1, 1.04, 1] }}
                transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
              >
                <svg viewBox="0 0 24 24" fill="white" className="w-[2.8cqw] h-[2.8cqw]">
                ...
                <span className="text-white font-bold text-[1.8cqw]">+675 7000 0000</span>
              </motion.div>
            </div>
            ...
            <AnimatePresence>
              {phase >= 4 && (
                <motion.div
                  className="bg-[#25D366] rounded-2xl rounded-tl-none shadow-xl px-[2cqw] py-[1.2cqw] flex-shrink-0"
                  initial={{ scale: 0, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
                  exit={{ scale: 0, opacity: 0 }}
                  transition={{ type: 'spring', bounce: 0.6 }}
                >
                  <span className="text-white text-[2cqw] font-bold block leading-snug">I want the bilum! 🛍️</span>
                  <span className="text-white/70 text-[1.4cqw]">via WhatsApp</span>
                </motion.div>
              )}
            </AnimatePresence>
          </motion.div>
