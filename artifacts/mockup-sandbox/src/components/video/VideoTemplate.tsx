...
export default function VideoTemplate() {
  ...
  // Try to autoplay as soon as audio is ready
  useEffect(() => {
    ...
    const tryPlay = () => {
      audio.play().catch(() => {
        // Autoplay blocked — user will use the toggle button
      });
      setAudioReady(true);
    };
      ...
      >
        {muted ? (
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-[2vw] h-[2vw]">
            <path d="M13 3.586L7.707 8.879A1 1 0 017 9H4a1 1 0 00-1 1v4a1 1 0 001 1h3a1 1 0 01.707.293L13 20.414V3.586zM16.243 7.757a1 1 0 011.414 0A8.966 8.966 0 0120 14a8.966 8.966 0 01-2.343 6.243 1 1 0 01-1.414-1.414A6.966 6.966 0 0018 14a6.966 6.966 0 00-1.757-4.829 1 1 0 010-1.414z" opacity="0.3"/>
